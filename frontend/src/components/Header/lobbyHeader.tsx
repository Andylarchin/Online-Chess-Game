    ...
    <>
      <div className='mainContainer'>
        <div className='headerContainer'>
          ...
          <div className='game-buttons-container'>
            ...
            >
              <img
                className='gameLogo'
                src='src\components\Header\favpng_time-measurement-clip-art.png'
              />
              <h3>Play 10 min</h3>
            </div>
            <div className='gameButton'>
              <img
                className='gameLogo'
                src='src\components\Header\icons8-chess-board-64.png'
              />
              <h3>New game</h3>
            </div>
            <div className='gameButton'>
              <img
                className='gameLogo'
                src='src\components\Header\icons8-old-computer-48.png'
              />
              <h3>vs Computer</h3>
            </div>
            <div className='gameButton'>
              <img
                className='gameLogo'
                src='src\components\Header\icons8-handshake-48.png'
              />
              <h3>Play a friend</h3>
            </div>
          </div>
        ...
        <div className='imagePanel'>
          <img src='src\components\Header\14609.e49d2fe3.png' />
          <div className='statsPanel'>
            ...
            <div className='imageStats'>
              <img src='src\components\Header\image.png'></img>
              <img src='src\components\Header\img\image2.png'></img>
              <img src='src\components\Header\img\image.png'></img>
            </div>
          </div>
        </div>
      </div>
